...
wordEmbeddings.append(vector)
label2Idx={'negative':0,'neutral':1,"positive":3,"conflict":2}
...
def SegmentLeftRight(sentences,aspect,labels,label2Idx):
	...
	while(j<len(sentences)):
		...
		segmentList.append([leftWords,rightWords,aspectWords,[labelId]])#,label2Idx[labels[i]]])
		j+=1
	return segmentList
...
print(testing_set_segmented[0:2])
